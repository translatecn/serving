...
const (
	...
	// For updated usage, please utilize knative.dev/serving/networking/pkg/http/header.UserAgentKey and
	// knative.dev/serving/networking/pkg/http/header.KubeProbeUAPrefix
