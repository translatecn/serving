...
import (
	...
	filtered "knative.dev/serving/caching/pkg/client/injection/informers/factory/filtered"
...
func Get(ctx context.Context, selector string) v1alpha1.ImageInformer {
	...
	if untyped == nil {
		overlogging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/serving/caching/pkg/client/informers/externalversions/caching/v1alpha1.ImageInformer with selector %s from context.", selector)
	}
