...
import (
	...
	fake "knative.dev/serving/caching/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		overlogging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/serving/caching/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
