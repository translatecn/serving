...
<td>
<p>这两个属性很重要 ✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️
DesiredScale 显示了此次修订所需的当前期望副本数量。</p>
</td>
</tr>
<tr>
<td>
...
<div>
<p>Destination 表示通过 HTTP 进行调用的目标。</p>
</div>
<table>
<thead>
<tr>
...
<td>
<em>(Optional)</em>
<p>URI 可以是一个绝对 URL 指向目标位置，也可以是一个相对 URI。相对 URI 将使用从 Ref 中获取的基 URI 进行解析。</p>
</td>
</tr>
<tr>
<td>
...
如果可寻址对象指定了受众信息，则目的地受众（Destinations Audience）将优先使用。</p>
</td>
</tr>
</tbody>
</table>
