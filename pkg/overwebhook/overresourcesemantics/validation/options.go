...
type options struct {
	path                  string
	types                 map[schema.GroupVersionKind]overresourcesemantics.GenericCRD
...
func WithTypes(types map[schema.GroupVersionKind]overresourcesemantics.GenericCRD) OptionFunc {
	return func(o *options) {
		o.types = types
	}
}
