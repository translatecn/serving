...
import (
	...
	kle "knative.dev/serving/pkg/overleaderelection"
...
// to implement, so that the shared overcontroller.Impl can drive work through it.
...
func FilterController(r overkmeta.OwnerRefable) func(obj interface{}) bool {
...
func (c *Impl) EnqueueSlow(obj interface{}) {
	object, err := overkmeta.DeletionHandlingAccessor(obj)
	if err != nil {
...
func (c *Impl) processNextWorkItem() bool {
	...
	ctx := overlogging.WithLogger(context.Background(), logger)
...
func NewContext(ctx context.Context, r Reconciler, options ControllerOptions) *Impl {
	...
	if options.Concurrency == 0 {
		options.Concurrency = DefaultThreadsPerController //2
	}
	i := &Impl{
