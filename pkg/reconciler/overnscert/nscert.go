...
import (
	...
	"knative.dev/serving/pkg/reconciler/overnscert/resources"
	domaincfg "knative.dev/serving/pkg/reconciler/overroute/overconfig"
)

// Reconciler implements overcontroller.Reconciler for Certificate resources.
