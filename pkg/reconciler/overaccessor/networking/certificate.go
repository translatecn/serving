...
func ReconcileCertificate(ctx context.Context, owner overkmeta.Accessor, desired *v1alpha1.Certificate, certAccessor CertificateAccessor) (*v1alpha1.Certificate, error) {
