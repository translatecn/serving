...
// Store is a overconfigmap.UntypedStore based config store.
type Store struct {
...
func (s *Store) Load() *Config {
	return &Config{
		RevisionGC: s.UntypedLoad(overgc.ConfigName).(*overgc.Config).DeepCopy(),
	}
}
