...
import (
	...
	gcconfig "knative.dev/serving/pkg/overgc"
...
func NewController(
	...
	return configreconciler.NewImpl(ctx, c, func(impl *overcontroller.Impl) overcontroller.Options {
		...
		configStore := configns.NewStore(overlogging.WithLogger(ctx, logger.Named("config-store")), resync)
