...
type accessor interface {
	list(ns, routeName string, state v1.RoutingState) ([]overkmeta.Accessor, error)
...
func makeMetadataPatch(
	acc overkmeta.Accessor, routeName string, addRoutingState, remove bool, clock clock.PassiveClock,
...
func markRoutingState(acc overkmeta.Accessor, clock clock.PassiveClock, diffLabels, diffAnn map[string]interface{}) {
...
func updateRouteAnnotation(acc overkmeta.Accessor, routeName string, diffAnn map[string]interface{}, remove bool) {
...
func (r *revisionAccessor) list(ns, routeName string, state v1.RoutingState) ([]overkmeta.Accessor, error) {
	kl := make([]overkmeta.Accessor, 0, 1)
...
// list implements Accessor
func (c *configurationAccessor) list(ns, routeName string, state v1.RoutingState) ([]overkmeta.Accessor, error) {
	kl := make([]overkmeta.Accessor, 0, 1)
	filter := func(m interface{}) {
