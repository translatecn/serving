...
import (
	...
	kparesources "knative.dev/serving/pkg/reconciler/autoscaling/overkpa/overresources"

	"knative.dev/serving/pkg/apis/duck"
	"knative.dev/serving/pkg/overlogging"

	netapis "knative.dev/serving/networking/pkg/apis/networking"
	...
	aresources "knative.dev/serving/pkg/reconciler/autoscaling/overresources"
...
func (ks *scaler) applyScale(ctx context.Context, pa *autoscalingv1alpha1.PodAutoscaler, desiredScale int32,
	...
	diff.Write("Deployment", ps, psNew)
	if err != nil {
