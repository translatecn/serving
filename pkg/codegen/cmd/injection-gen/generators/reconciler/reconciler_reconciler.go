...
func (g *reconcilerReconcilerGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"controllerImpl": c.Universe.Type(types.Name{
			Package: "knative.dev/serving/pkg/controller",
			Name:    "Impl",
		}),
		...
		"reconcilerEvent":                c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/reconciler", Name: "Event"}),
		"reconcilerReconcilerEvent":      c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/reconciler", Name: "ReconcilerEvent"}),
		"reconcilerRetryUpdateConflicts": c.Universe.Function(types.Name{Package: "knative.dev/serving/pkg/reconciler", Name: "RetryUpdateConflicts"}),
		"reconcilerConfigStore":          c.Universe.Type(types.Name{Name: "ConfigStore", Package: "knative.dev/serving/pkg/reconciler"}),
		"reconcilerOnDeletionInterface":  c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/reconciler", Name: "OnDeletionInterface"}),
		// Deps
		...
		"reconcilerLeaderAware": c.Universe.Type(types.Name{
			Package: "knative.dev/serving/pkg/reconciler",
			Name:    "LeaderAware",
		}),
