...
func (g *filteredInjectionGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterFilteredInformers": c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/injection", Name: "Default.RegisterFilteredInformers"}),
		"controllerInformer":                 c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/controller", Name: "Informer"}),
