...
import (
	...
	gennamer "knative.dev/serving/pkg/codegen/cmd/injection-gen/namer"
)
...
func (g *duckGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterDuck":     c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/injection", Name: "Default.RegisterDuck"}),
		"getResyncPeriod":           c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/controller", Name: "GetResyncPeriod"}),
		"dynamicGet":                c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/injection/clients/dynamicclient", Name: "Get"}),
		"duckTypedInformerFactory":  c.Universe.Type(types.Name{Package: "knative.dev/serving/pkg/apis/duck", Name: "TypedInformerFactory"}),
