...
type options struct {
	path                  string
	types                 map[schema.GroupVersionKind]over_resourcesemantics.GenericCRD
...
func WithTypes(types map[schema.GroupVersionKind]over_resourcesemantics.GenericCRD) OptionFunc {
	return func(o *options) {
		o.types = types
	}
}
